...
public class Application {
    public static void main(String[] args) {
        ...
        Graph graph = application.createNewGraph();
        ...
        for(int i=0; i<Configuration.instance.numberOfRuns; i++){
            Graph cutGraph = application.minCut(application.createNewGraph());
        ...
        if(Configuration.instance.showProbability){
            float minCount = 0;
            float total = Configuration.instance.numberOfRuns;
            ...
            float probability = minCount/total;
            float probabilityPercentage = probability * 100;

            System.out.println();
            System.out.println((int)minCount + " of the " + (int)total + " runs resulted in a MinCut. Percentage: " + probabilityPercentage);
        }
    }
